...
public class Layout {
   ...
   public Layout(Schema schema) {
      ...
      for (String fldname : schema.fields()) {
          ...
          bitPositions.put(fldname, bitPosition); // Assign bit position
    ...
    */
   public Layout(Schema schema, Map<String,Integer> offsets, int slotsize, Map<String, Integer> bitPositions) {
      this.schema    = schema;
